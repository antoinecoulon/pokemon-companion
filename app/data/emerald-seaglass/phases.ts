    ...
    tasks: [
      {
        ...
        details: [
          ...
          'Composition retenue (guide personnel généré pour ce run, recoupé avec ce Pokédex et la doc officielle v3.0) — fiches déjà écrites sous **Équipe**, statut « cible » tant qu’ils ne sont pas capturés :',
          '**Sceptile** (starter, Plante/Dragon) — sweeper rapide, mur anti-Eau/Électrik/Sol. Six faiblesses dont Glace ×4 : ne jamais l’envoyer contre Glacia.',
          '**Skarmory** (Acier/Vol) — Route 113 ou Safari Zone N, capture directe. Résiste Glace/Dragon/Fée ×½, Insecte ×¼, immunisé Sol et Poison : la réponse à la Glace ×4 de Sceptile.',
          '**Gardevoir** (Psy/Fée), via Ralts — Route 102. Immunité Dragon, clé contre Brawly (résiste le Combat ×¼).',
          '**Houndoom** (Ténèbres/Feu), via Houndour — Route 112 / Mt. Pyre extérieur. Immunisé Psy (Tate & Liza), résiste le Feu — couvre la faiblesse Feu de Skarmory.',
          '**Azumarill** (Eau/Fée), via Marill — Route 104. Anti-Feu et anti-Sol, deuxième immunité Dragon.',
          '**Crobat** (Poison/Vol), via Zubat — Granite Cave, tous les étages. Immunisé Sol, très rapide (130 Vit).',
          '⚠️ Le guide personnel donnait ce rôle « anti-Glace » à **Aggron** avec un typage Acier/Roche. Vérifié faux : Aggron est **Acier/Dragon** dans ce hack (ce Pokédex, et ligne 336 de la doc officielle v3.0), donc neutre à la Glace, pas résistant. D’où Skarmory à sa place.',
          'Remplaçants situationnels, vérifiés mais non fichés : **Milotic** (Eau/Fée, via Feebas Route 119) en mur spécial à la place d’Azumarill · **Absol** (Ténèbres pur, Route 120 / Mt. Pyre Summit) à la place de Houndoom si Houndour tarde · **Tyranitar** (Roche/Ténèbres, Larvitar en Safari Zone NW / Seafloor Cavern, évolution tardive Lv 55) ou **Steelix** (Acier/Sol, Onix + Metal Coat) à la place de Skarmory pour un mur plus lourd, au prix de la réponse à la Glace pour Tyranitar, ou de la Vitesse pour Steelix.',
          'Utilitaires possibles (boîte, pas équipe active) : **Zigzagoon/Linoone** ou **Meowth/Persian** (talent Pickup, farm d’objets passif dès les premières routes) · **Chansey/Blissey** (250+ PV, encaisse l’EV training pendant qu’on farme l’argent des vitamines).',
        ],
        requires: ['phase-1.15'],
        link: '/equipe',
        key: true,
